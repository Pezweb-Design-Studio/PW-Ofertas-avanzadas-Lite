...
class RecurringPurchaseStrategy implements DiscountStrategy {
    ...
    public static function getMeta(): array {
        return [
            ...
            'effectiveness' => 5,
            'when_to_use' => 'Productos de recompra: cosméticos, suplementos, alimentos. Aumenta retención 40-60%. Ideal para suscripciones o productos consumibles.',
            'objective' => 'loyalty'
        ];
    }
    ...
    public static function getConfigFields(): array {
        return [
            [
                'key' => 'required_purchases',
                'label' => 'Número de compras previas requeridas',
                'type' => 'number',
                'default' => 3,
                'required' => true,
                'description' => 'Cuántas veces debe haber comprado el producto para obtener descuento'
            ],
            [
                'key' => 'discount_type',
