...
console.log('🔍 [ADDON] pwoaData:', typeof pwoaData !== 'undefined' ? pwoaData : 'UNDEFINED');
console.log('🔍 [ADDON] Edition:', typeof pwoaData !== 'undefined' ? pwoaData.edition : 'UNDEFINED');
...
PWOAWizard.renderStrategies = function(strategies) {
    console.log('🟢 [RENDER] renderStrategies llamado con', strategies.length, 'strategies');
