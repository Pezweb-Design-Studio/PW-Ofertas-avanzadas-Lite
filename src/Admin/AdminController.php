...
class AdminController
{
    public function __construct()
    {
        ...
        add_action("wp_ajax_pwoa_save_settings", [$this, "ajaxSaveSettings"]);
    }
    ...
    {
        $stacking_behavior = get_option(
            "pwoa_stacking_behavior",
            "priority_first",
        );
    ...
    public function ajaxSaveSettings(): void
    {
        ...
        $stacking_behavior = sanitize_text_field(
            $_POST["stacking_behavior"] ?? "priority_first",
        );

        $valid_behaviors = ["priority_first", "stack_first", "max_discount"];
        if (!in_array($stacking_behavior, $valid_behaviors)) {
