...
<div class="wrap">
    ...
    <h1 class="text-4xl font-bold mb-12">Analíticas</h1>

    <div class="grid grid-cols-4 gap-6 mb-12">

        <div class="bg-white p-8 rounded-lg shadow">
            <p class="text-gray-500 mb-2">Órdenes con Descuento</p>
            <p class="text-4xl font-bold"><?php echo number_format($stats['total_orders']); ?></p>
        </div>

        <div class="bg-white p-8 rounded-lg shadow">
            <p class="text-gray-500 mb-2">Total Descontado</p>
            <p class="text-4xl font-bold">$<?php echo number_format($stats['total_discounted'], 0); ?></p>
        </div>

        <div class="bg-white p-8 rounded-lg shadow">
            <p class="text-gray-500 mb-2">Descuento Promedio</p>
            <p class="text-4xl font-bold">$<?php echo number_format($stats['avg_discount'], 0); ?></p>
        </div>

        <div class="bg-white p-8 rounded-lg shadow">
            <p class="text-gray-500 mb-2">Ingresos Totales</p>
            <p class="text-4xl font-bold">$<?php echo number_format($stats['total_revenue'], 0); ?></p>
        </div>
            ...
            <table class="w-full">
                ...
                <?php foreach ($top_campaigns as $campaign): ?>
                    <tr class="border-b">
                        ...
                        <td class="text-right py-4 font-bold">$<?php echo number_format($campaign->total_discounted, 0); ?></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
